...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey }, "o", function()
		scratchpad.toggle_and_restore("fsearch")
	end, {
	...
	awful.key({ modkey }, "z", function()
		scratchpad.toggle_and_restore("qv2ray")
	end, {
		description = "qv2ray scratchpad",
		group = "scratchpad",
	}),
	awful.key({ modkey, shift }, "g", function()
		scratchpad.toggle_and_restore("galaxy")
	end, {
		description = "galaxy scratchpad",
		group = "scratchpad",
	}),
})
...
client.connect_signal("request::default_keybindings", function()
	awful.keyboard.append_client_keybindings({
		...
		awful.key({ modkey, shift }, "_", function()
