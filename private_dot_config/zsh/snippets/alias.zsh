alias xmodconfig='[ -f "$HOME/.Xmodmap" ] && xmodmap "$HOME/.Xmodmap"'
alias rz="source /home/jczhang/.config/zsh/zshrc.zsh"

# global alias
alias -g H='| head ' T='| tail ' L='| less '
...
alias tweb='docker run -d -p 18989:80 --name taskwarrior-webui -v $HOME/.taskrc:/.taskrc -v $HOME/.task:/.task dcsunset/taskwarrior-webui'
