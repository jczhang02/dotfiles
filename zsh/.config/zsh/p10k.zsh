# Generated by Powerlevel10k configuration wizard on 2022-04-13 at 17:45 CST.
...
# dotted, full frame, lightest-ornaments, compact, many icons, fluent,
...
function prompt_my_cpu_temp() {
  integer cpu_temp="$(</sys/class/thermal/thermal_zone0/temp)"
  if (( cpu_temp >= 80 )); then
